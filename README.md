...
These workflows were developed and validated while preprocessing satellite data for **study plots across the Iberian Peninsula**, as part of a project: **Below,Litter & Shrub BIOMASS density mapping combining optical, LiDAR and SAR Earth Observation data (BLS-BIOMASS)** (https://www.isa.ulisboa.pt/daf/nrh/concursos/bolseiros/bolsa-de-investigacao-119) by **Instituto Superior de Agronomia, Universidade de Lisboa, Portugal,** funded by **European Space Agency**. 
